        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrenceUnit = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    FirstDueDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackedTasks_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompletionLogs_TrackedTasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompletionLogs_CompletedAt",
                table: "CompletionLogs",
                column: "CompletedAt");

            migrationBuilder.CreateIndex(
                name: "IX_CompletionLogs_TaskId",
                table: "CompletionLogs",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackedTasks_CategoryId",
                table: "TrackedTasks",
                column: "CategoryId");
